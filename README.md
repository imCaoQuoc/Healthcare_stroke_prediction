...
In this repository, we provide an example of how to build a sequential model using the TensorFlow library in Python. The model is trained on a stroke dataset and used to classify whether someone could be stroke or not.